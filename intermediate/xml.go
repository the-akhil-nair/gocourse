...
type Person struct {
	// This is going to be the root element.
	// It is used to detrmine the name of the root element during marshalling and unmarshalling.
	// If this field is not present, the name of the struct will be used as the root element.
...
// This struct is used to demonstrate nested elements and attributes.
// If it is done in same struct, it will be difficult to differentiate between attributes and elements.
type Pseudo struct {
