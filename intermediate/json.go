...
type Person struct {
	// tags can be used at the time of defining column names or primary keys etc for database orm.
	FirstName    string  `json:"name"`          //`db:"user_id"`
	Age          int     `json:"age,omitempty"` // omitempty will skip the field if it has zero value while marshalling
